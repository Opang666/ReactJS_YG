        ...
        <div className="feed">
            <div className="create-post">
                ...
                <div className="post-actions">
                    <label htmlFor="photo-upload"><img src="/images/img/img.png" alt="Photo Icon" /></label>
                    <input type="file" id="photo-upload" accept="image/*" style="display: none;" />
                    <label htmlFor="video-upload"><img src="/images/img/vid.png" alt="Video Icon" /></label>
                    <input type="file" id="video-upload" accept="video/*" style="display: none;" />
                    <label htmlFor="file-upload"><img src="/images/img/file.png" alt="File Icon" /></label>
                    <input type="file" id="file-upload" style="display: none;" />
                    <label htmlFor="emoji"><img src="/images/img/emot.png" alt="File Icon" /></label>
